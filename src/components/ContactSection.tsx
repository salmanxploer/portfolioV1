...
import { Github, Linkedin, Mail, Twitter, Instagram, Send, MessageSquare, MapPin, Phone, CheckCircle2, XCircle, Loader2 } from "lucide-react";
...
const socials = [
  ...
  { name: "Instagram", icon: Instagram, url: "https://www.instagram.com/salmanh_shuvo/", color: "hover:text-neon-pink hover:border-neon-pink", glow: "hover:shadow-[0_0_20px_hsl(330_100%_60%/0.5)]" },
